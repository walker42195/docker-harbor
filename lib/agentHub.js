...
class AgentHub {
  ...
  handleUpgrade(req, socket, head) {
    ...
    if (this.isBlocked(ip)) {
      // Svara med 429 i stallet for att tyst riva socketen. En tyst destroy
      // syns bara som "socket hang up"/1006 hos agenten, vilket gor varje
      // autentiseringsproblem omojligt att felsoka.
      console.warn(`[agent-hub] avvisar blockerad IP ${ip} (429)`);
      socket.write(
